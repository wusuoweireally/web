  ...
  <div class="min-h-screen bg-base-200">
    ...
    <nav class="navbar bg-base-100 shadow-sm">
      <div class="flex-1">
        ...
        <h1 class="ml-4 text-xl font-bold">编辑资料</h1>
      </div>
    </nav>
          ...
          <div class="card-body">
            ...
            <div class="form-control">
              ...
              <div class="flex items-center gap-6">
                <div class="avatar">
                  <div
                    class="h-20 w-20 rounded-full ring ring-primary ring-offset-2 ring-offset-base-100"
                  >
                    <img
            ...
            <div class="form-control">
              ...
              <label class="label">
                <span class="label-text-alt"
                  >{{ formData.bio?.length || 0 }}/500</span
                >
              </label>
